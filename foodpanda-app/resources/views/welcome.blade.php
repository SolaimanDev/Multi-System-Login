...
<body class="bg-gray-100 text-gray-800 antialiased font-sans">
    ...
    <div class="min-h-screen flex flex-col items-center justify-center px-4">
        <div class="text-center mb-8">
            <h1 class="text-4xl font-bold text-gray-900">Welcome to <span class="text-red-500">Foodpanda</span></h1>
            <p class="mt-2 text-gray-600">A simple Laravel SSO demo using JWT</p>
        </div>
        ...
        @if (session('error'))
            <div class="mt-6 p-4 bg-red-100 text-red-700 rounded w-full max-w-md text-center">
                {{ session('error') }}
            </div>
        @endif
    </div>
